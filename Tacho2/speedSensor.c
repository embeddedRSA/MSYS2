...
static float sumint8(revPerSec);
...
float getSpeedKMH(void) //WORKS TESTED 
{
	...
	float KMH = (sumint8(revPerSec) >> 2)*revLength*3.6; // Revolutions per second times revolution length = m/s. time 3.6 = km/h
